...
CITY_HISTORIC_SEARCHES: dict[str, list[str]] = {
    ...
    # Города без единого фото — по 5 фото исторического центра (без промышленности)
    "arhangelsk": [
        "Arkhangelsk historic center",
        "Arkhangelsk Northern Dvina embankment",
        "Arkhangelsk Gostiny Dvor",
        "Arkhangelsk cathedral",
        "Arkhangelsk wooden houses",
    ],
    "bryansk": [
        "Bryansk historic center",
        "Bryansk cathedral",
        "Bryansk Desna embankment",
        "Bryansk central square",
    ],
    "cheboksary": [
        "Cheboksary historic center",
        "Cheboksary Volga embankment",
        "Cheboksary bay",
        "Cheboksary cathedral",
    ],
    "grozny": [
        "Grozny Akhmad Kadyrov Mosque",
        "Grozny city center",
        "Grozny Heart of Chechnya",
    ],
    "kaliningrad": [
        "Kaliningrad Cathedral",
        "Kaliningrad Kneiphof",
        "Kaliningrad historic center",
        "Kaliningrad Pregolya embankment",
    ],
    "kaluga": [
        "Kaluga historic center",
        "Kaluga Oka embankment",
        "Kaluga space museum",
        "Kaluga cathedral",
    ],
    "kirov": [
        "Kirov Vyatka embankment",
        "Kirov historic center",
        "Kirov cathedral",
    ],
    "komsomolsk_na_amure": [
        "Komsomolsk-on-Amur Amur embankment",
        "Komsomolsk-on-Amur city center",
        "Komsomolsk-on-Amur Lenin square",
    ],
    "kostroma": [
        "Kostroma Ipatiev Monastery",
        "Kostroma Volga embankment",
        "Kostroma historic center",
        "Kostroma Susanin square",
    ],
    "kursk": [
        "Kursk Red Square",
        "Kursk cathedral",
        "Kursk historic center",
    ],
    "lipetsk": [
        "Lipetsk cathedral",
        "Lipetsk historic center",
        "Lipetsk Voronezh embankment",
    ],
    "petrozavodsk": [
        "Petrozavodsk Onega embankment",
        "Petrozavodsk historic center",
        "Petrozavodsk Kizhi",
        "Petrozavodsk Lenin square",
    ],
    "simferopol": [
        "Simferopol central square",
        "Simferopol cathedral",
        "Simferopol Salgir embankment",
    ],
    "smolensk": [
        "Smolensk Kremlin",
        "Smolensk cathedral",
        "Smolensk Dnieper embankment",
        "Smolensk historic center",
    ],
    "sterlitamak": [
        "Sterlitamak city center",
        "Sterlitamak Belaya river",
        "Sterlitamak square",
    ],
    "taganrog": [
        "Taganrog Chekhov house",
        "Taganrog sea embankment",
        "Taganrog historic center",
    ],
    "tambov": [
        "Tambov cathedral",
        "Tambov Tsna embankment",
        "Tambov historic center",
    ],
    "tula": [
        "Tula Kremlin",
        "Tula historic center",
        "Tula Upa embankment",
        "Tula arms museum",
    ],
    "vladikavkaz": [
        "Vladikavkaz Terek embankment",
        "Vladikavkaz cathedral",
        "Vladikavkaz historic center",
    ],
    "volzhsky": [
        "Volzhsky city center",
        "Volzhsky Volga",
        "Volzhsky square",
    ],
}
...
FALLBACK_COMMONS_TITLES: dict[str, list[str]] = {
    ...
    "arhangelsk": [
        "File:Arkhangelsk view from Vysotka.jpg",
        "File:Arkhangelsk P7151205 2200.jpg",
        "File:Arkhangelsk. Northern Dvina River P7151363 2200.jpg",
    ],
    "bryansk": [
        "File:Bryansk (2022-06-24) 12.jpg",
        "File:Bryansk (2022-06-24) 07.jpg",
    ],
    "cheboksary": [
        "File:Cheboksary. Dormition Church P8121972 2200.jpg",
        "File:Cheboksary. Dormition Church P8121970 2200.jpg",
        "File:Cheboksary. View of downtown.jpg",
    ],
    "grozny": [
        "File:Grozny, Russia, Akhmad Kadyrov Mosque.jpg",
        "File:Grozny Kadyrov Mosque.jpg",
        "File:Grozny. Grozny-City Towers. Mosque The Heart of Chechnya PB040055 2200.jpg",
    ],
    "kaliningrad": [
        "File:RU Kaliningrad Cathedral.JPG",
        "File:Kaliningrad 05-2017 img04 Kant Island.jpg",
        "File:Cathedral of Christ the Saviour (Kaliningrad) 20180812.jpg",
    ],
    "kaluga": [
        "File:Kaluga 2012 MainSquare 03 1TM.jpg",
        "File:Kaluga Tsiolkovskogo 79 east 02.jpg",
    ],
    "kirov": [
        "File:Vyatka-Kirov asv2019-05 img34 Vyatka River.jpg",
        "File:Vyatka-Kirov asv2019-05 img23 Holy Mandylion Church.jpg",
        "File:Vyatka river. Kirov. Russia. Река Вятка. Киров. Россия - panoramio.jpg",
    ],
    "kostroma": [
        "File:Kostroma. Ipatiev Monastery P7150297 2350.jpg",
        "File:Kostroma. Ipatiev Monastery P7150308 2350.jpg",
        "File:Ipatiev Monastery from Volga.jpg",
    ],
    "petrozavodsk": [
        "File:Pier on Lake Onega, Petrozavodsk, Republic of Karelia, Russian Federation. - panoramio.jpg",
        "File:Lake Onega quay - Petrozavodsk, Russia - panoramio.jpg",
    ],
    "smolensk": [
        "File:Assumption Cathedral in Smolensk (8511895045).jpg",
        "File:Smolensk Cathedral.jpg",
        "File:Cathedral of the Dormition (Smolensk) - 15.jpg",
    ],
    "sterlitamak": [
        "File:Sterlitamak trolleybus and city mosque 2012-11.jpg",
        "File:Sterlitamak, Republic of Bashkortostan, Russia - panoramio.jpg",
    ],
    "taganrog": [
        "File:Taganrog. Chekhov Street P1000179 2600.jpg",
        "File:Taganrog. Chekhov Street P1000180 2600.jpg",
    ],
    "tambov": [
        "File:Transfiguration Cathedral - 001.jpg",
        "File:Tambov. Statue of Saint Pitirim P7180171 2575.jpg",
        "File:Transfiguration Cathedral - 002.jpg",
    ],
    "tula": [
        "File:Tula Kremlin P5243585 2925.jpg",
        "File:Tula. Kremlin P5243601 2600.jpg",
        "File:Tula asv2019-09 img06 Kremlin aerial view.jpg",
    ],
    "vladikavkaz": [
        "File:Vladikavkaz. Terek River PA160756 2575.jpg",
        "File:Terek Mosque.JPG",
    ],
    "volzhsky": [
        "File:Volzhsky, Volgograd Oblast (8).jpg",
        "File:Volzhsky, Volgograd Oblast (7).jpg",
        "File:Volzhsky, Volgograd Oblast (1).jpg",
    ],
}
    ...
    for attempt in range(retries + 1):
        try:
            ...
            if e.code == 429 and attempt < retries:
                wait = 120
                print(f"  [429 rate limit] пауза {wait} с...")
                time.sleep(wait)
                continue
            if attempt >= retries:
                return None
...
def main():
    import sys
    only_slugs = set(sys.argv[1:]) if len(sys.argv) > 1 else None  # только эти города, если переданы
    ...
    for slug, queries in CITY_HISTORIC_SEARCHES.items():
        ...
        while added < len(next_indices) and slug in FALLBACK_COMMONS_TITLES:
            ...
            if not chosen:
                break
            time.sleep(1.2)  # больше пауза перед загрузкой — меньше риск 429
            img_url = _get_image_url_from_title(chosen)
            if not img_url:
                used.add(chosen)
                continue
